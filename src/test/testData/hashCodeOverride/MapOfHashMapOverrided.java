...
public class MapOfHashMapOverrided {
    public static void main(String[] args) {
        Map<Clazz1, Integer> clazz1IntegerMap = Map.of(new Clazz1(), 1);
        Map<Clazz2, Integer> clazz2IntegerMap = <weak_warning descr="Class 'Clazz2' doesnt contain overrided hashCode()">Map.of(new Clazz2(), 1)</weak_warning>;
