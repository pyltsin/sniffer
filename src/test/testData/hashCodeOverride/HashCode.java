...
public class HashCode {
    public static void main(String[] args) {
        Map<Clazz1, Integer> clazz1IntegerMap = <weak_warning descr="Class 'Clazz1' does not contain overrided hashCode() or equals(..) methods">Map.of(new Clazz1(), 1)</weak_warning>;
        ...
        Set<Clazz1> clazz1s = <weak_warning descr="Class 'Clazz1' does not contain overrided hashCode() or equals(..) methods">Set.of(new Clazz1())</weak_warning>;
        ...
        HashMap<Clazz1, String> map1 = <weak_warning descr="Class 'Clazz1' does not contain overrided hashCode() or equals(..) methods">new HashMap<>()</weak_warning>;
        ...
        Set<Clazz1> set1 = <weak_warning descr="Class 'Clazz1' does not contain overrided hashCode() or equals(..) methods">new HashSet<>()</weak_warning>;
        ...
        Set<Clazz1> collectSet1 = <weak_warning descr="Class 'Clazz1' does not contain overrided hashCode() or equals(..) methods">Stream.of(new Clazz1(), new Clazz1())
        ...
        Set<Clazz1> collectSet4 = <weak_warning descr="Class 'Clazz1' does not contain overrided hashCode() or equals(..) methods">Stream.of(new Clazz1(), new Clazz1())
